...
VR::setDataDir(QString d)
{
  ...
  {
    CaptionWidget *capWidget = new CaptionWidget();
    capWidget->generateCaption("label", "");
  }
}
...
VR::hideLabel()
{
  CaptionWidget::setTexture("label", 0, QSize());
}

void
VR::showLabel(GLuint texId, QSize texSize)
{
  CaptionWidget::setTexture("label", texId, texSize);
}
